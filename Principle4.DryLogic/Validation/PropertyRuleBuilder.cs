...
namespace Principle4.DryLogic.Validation
{
	public class PropertyRuleBuilder
	{
		...
		public PropertyRuleBuilder Unless(Func<ObjectInstance, Boolean> skipCondition)
		{
			CurrentRule.Condition = new Func<ObjectInstance, Boolean>(oi => !skipCondition(oi));
			return this;
		}
		public PropertyRuleBuilder ForceEmitClientSide()
		{
			CurrentRule.ForceEmitClientSide = true;
			return this;
		}
	...
	public class TypedPropertyRuleBuilder<T> : PropertyRuleBuilder
	{
		public TypedPropertyRuleBuilder(PropertyDefinition property) : base (property)
		{

		}
		public PropertyRuleBuilder IsDependentOn(Func<ObjectInstance, Boolean> assertion)
		{
			var rule = new PropertyRule(this.Property);
			rule.Assertion = assertion;
			this.AddRule(rule);
